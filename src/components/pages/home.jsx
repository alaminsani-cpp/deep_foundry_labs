        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="mt-4 text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight text-slate-900">
              Your{' '}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 via-sky-500 to-indigo-500">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <button className="px-6 py-3 bg-black text-white rounded-lg hover:bg-gray-900 transition flex items-center gap-2">
            ...
            <ul className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                <li key={text} className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm">
                  <Icon className="h-5 w-5 text-cyan-600 flex-shrink-0" />
    ...
    />
      ...
      <section className="py-16">
        <div className="text-center mb-12">
          <span className="text-xs tracking-widest uppercase text-cyan-600 font-medium">What We Do</span>
          <h2 className="mt-3 text-3xl md:text-4xl font-medium text-gray-900">R&D Services</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((s) => (
            <div key={s.title} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-shadow group">
      ...
      <section className="py-16">
        <div className="text-center mb-12">
          <span className="text-xs tracking-widest uppercase text-cyan-600 font-medium">Who We Serve</span>
          <h2 className="mt-3 text-3xl md:text-4xl font-medium text-gray-900">Industries</h2>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {["Finance", "Healthcare", "Media", "AgriTech"].map((ind) => (
            <div key={ind} className="rounded-2xl border border-gray-200 bg-white py-8 text-center font-medium hover:shadow-md transition-shadow">
              {ind}
            </div>
          ))}
        </div>
      ...
      <section className="py-16">
        <div className="text-center mb-12">
          <span className="text-xs tracking-widest uppercase text-cyan-600 font-medium">Proof of Value</span>
          <h2 className="mt-3 text-3xl md:text-4xl font-medium text-gray-900">Case Studies</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          {cases.map((c) => (
            <div key={c.title} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-shadow">
              <span className="text-sm font-medium text-cyan-600">{c.tag}</span>
              <h3 className="text-xl font-medium text-gray-900 mt-2 mb-3">{c.title}</h3>
              <p className="text-sm text-gray-600 mb-4">{c.blurb}</p>
              <p className="text-sm">
                <span className="font-medium">Result:</span>{' '}
                <span className="text-emerald-600 font-medium">{c.result}</span>
              </p>
            </div>
          ))}
        </div>
      ...
      <section className="py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="text-xs tracking-widest uppercase text-cyan-600 font-medium">About</span>
          ...
          <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-lg">
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={stat.label} className="p-6 rounded-2xl bg-gray-50">
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <span className="text-xs tracking-widest uppercase text-cyan-600 font-medium">Contact</span>
            <h2 className="mt-3 text-3xl md:text-4xl font-medium text-gray-900">
          ...
          <div className="space-y-6 bg-white border border-gray-200 rounded-2xl p-8 shadow-lg">
